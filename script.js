...
volumeIcon.addEventListener('click', toggelMute);
speed.addEventListener('change', changespeed);
fullscreenBtn.addEventListener('click', togglrFullscreen);